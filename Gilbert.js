	...
	client.on('message-new', async (mek) => {
		...
		try {
			...
			var ase = new Date();
                ...
                case 22: waktoo = "Selamat Malam🌚\n - Jangan Lupa Ngocok & Jangan Gadang"; break;
...
break
		...
		case 'request':
					...
					client.sendMessage('6281235136510@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6281235136510@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6281235136510@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER,MOHON BERSABAR')
					break
		case 'blocklist': 
           ...
           case 'setname':
			...
			case 'promote':
					...
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `*Selamat* 🥳 *Anda naik menjadi admin group(pasti orang dalem ya🗿)* 🎉 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
...
║╠ Contoh: 
║╠ #suratto 6281235136510|Hai Juga
║╚▸
╚═══ ◤ *${namabot}* ◢ `
...
client.sendMessage(from, Mau, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
		...
		if (budy.includes(`6281235136510`)) {
                  reply(`Jangan Tag Owner Kontol,anjing lu`)
		...
		if (budy.includes(`SCRIP`)) {
          reply('Bot Ini Menggunakan SC:🤨📸')
                  ...
                  if (budy.includes(`Halo Bot`)) {
         reply('Halo juga,ada apa ya?') 
                  }
                  if (budy.includes(`Bro bagi sc dong`) 
         reply(BIKIN SENDIRI LAH KONTOL, KAN PUNYA OTAK AMA TANGAN LU!! `)) {
                  }
                  if (budy.includes(`bot kontol`) 
         reply(ELU YANG KONTOL, BISANYA NGE KRITIK DOANG, DONGO)) {
         	     }
          ...
          reply('Gpp Kok')
                  ...
                  if (budy.includes(`kamu marah ga? `)) {
          reply('aku gak marah')
                  }
